			...
			IF OBJECT_ID('report.loss_scenario_table', 'U') IS NULL
				BEGIN
					CREATE TABLE report.loss_scenario_table(
						...
						id_client INT NOT NULL,
						id_plant INT NOT NULL,
						loss_scenario_material_damage_amount DECIMAL(19, 4) NULL,
						loss_scenario_material_damage_percentage FLOAT(2) NULL,
						loss_scenario_business_interruption_amount DECIMAL(19, 4) NULL,
						loss_scenario_business_interruption_percentage FLOAT(2) NULL,
						loss_scenario_building_amount DECIMAL(19, 4) NULL,
						loss_scenario_machinary_equipment_amount DECIMAL(19, 4) NULL,
						loss_scenario_electronic_equipment_amount DECIMAL(19, 4) NULL,
						loss_scenario_expansions_investment_works_amount DECIMAL(19, 4) NULL,
						loss_scenario_stock_amount DECIMAL(19, 4) NULL,
						loss_scenario_total_insured_values DECIMAL(19, 4) NULL,
