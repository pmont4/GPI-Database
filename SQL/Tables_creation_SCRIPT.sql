			...
			IF OBJECT_ID('report.perils_and_risk_table', 'U') IS NULL
				BEGIN
					CREATE TABLE report.perils_and_risk_table(
						...
						id_report INT NOT NULL,
						id_plant INT NOT NULL,
						perils_and_risk_fire_explosion FLOAT NOT NULL,
						perils_and_risk_landslide_subsidence FLOAT NOT NULL,
						perils_and_risk_water_flooding FLOAT NOT NULL,
						perils_and_risk_wind_storm FLOAT NOT NULL,
						perils_and_risk_lighting FLOAT NOT NULL,
						perils_and_risk_earthquake FLOAT NOT NULL,
						perils_and_risk_tsunami FLOAT NOT NULL,
						perils_and_risk_collapse FLOAT NOT NULL,
						perils_and_risk_aircraft FLOAT NOT NULL,
						perils_and_risk_riot FLOAT NOT NULL,
						perils_and_risk_design_failure FLOAT NOT NULL,
						perils_and_risk_overall_rating FLOAT NOT NULL,
